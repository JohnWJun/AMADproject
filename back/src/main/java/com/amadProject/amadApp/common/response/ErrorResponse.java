package com.amadProject.amadApp.common.response;
...
//    @Getter
//    public static class BusinessLogicExceptionError{
//        private int status;
//        private String message;
//
//        public BusinessLogicExceptionError(int status, String message) {
//            this.status = status;
//            this.message = message;
//        }
